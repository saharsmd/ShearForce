...
if __name__ == "__main__":
    ...
    executable = Path(*Path.cwd().parts[:-4],
                      ...
                      "TestSinusoidalShearForceNematic")
    ...
    outdir_stem = "Sinusoidal_Shear_Force_Nematic_output/"
    ...
    outdir_labels = ["nx", "dt", "P0", "F0", "F1", "KA", "KP", "lambda", "seed"]
    ...
    n_cpus = 8    # Number of simultaneous processes to run, i.e
